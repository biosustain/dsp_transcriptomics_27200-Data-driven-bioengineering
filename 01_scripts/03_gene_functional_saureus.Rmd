...
3. Compare 'Genes tested (background)' from the DE-loading step with 'Genes in ranked list' printed here. Genes vanish for two reasons: some got no p-value from DESeq2 at all, but the interesting ones have pvalue = 0 — below machine precision, i.e. your very STRONGEST hits — yet GSEA never sees them. Predict what their absence does to the NES of a pathway they belong to, then compare your GSEA table with your ORA table: is any set weakened or missing on the GSEA side that ORA found? Is dropping these genes a bug or a defensible modelling choice?
:::
