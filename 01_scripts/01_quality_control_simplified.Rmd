...
```{r topvar-heatmap-0, echo=TRUE, eval=TRUE, include=TRUE, message=FALSE, warning=FALSE, fig.width=8, fig.height=12}
...
```{r heat0-0, echo=FALSE, eval=FALSE, include=FALSE, message=FALSE, warning=FALSE, fig.width=8, fig.height=12}
...
### Add gene names
```{r gene-name-map, echo=TRUE, eval=TRUE, include=TRUE, message=FALSE, warning=FALSE}
...
```{r heat-plot-name, echo=TRUE, eval=TRUE, include=TRUE, message=FALSE, warning=FALSE, fig.width=8, fig.height=12}
topVarGenes <- head(order(rowVars(assay(vsd)), decreasing = TRUE), 50)
