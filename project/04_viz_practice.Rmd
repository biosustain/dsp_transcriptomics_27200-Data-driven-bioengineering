...
<strong>⭐ Important:</strong> This script assumes you have already run the E. coli Quality Control chapter (`03_analysis_basics.Rmd`), which saves the `dds` object to `results/rds/`. If not, run that script first.
:::
