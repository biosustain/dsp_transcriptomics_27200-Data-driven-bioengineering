...
The *S. aureus* and human datasets analysed in the next parts of this book were processed with this same pipeline; the human run is documented in `01_scripts/00_nfcore_rnaseq_processing.sh` (kept as provenance — its outputs are already committed, you do not need to run it).
...
We will be analyzing the [multiQC report from processing the entire dataset](https://github.com/biosustain/dsp_transcriptomics_27200-Data-driven-bioengineering/blob/main/results/multiqc_nfcore_rnaseq_full_dataset/multiQC_Ecoli_sac_ctrl_deDios_2025_full_dataset.html) - which we have done prior to this course - rather than the one generated in your test run. (On GitHub, click **Download raw file** and open the downloaded HTML in your browser; in a Codespace, right-click the file under `results/multiqc_nfcore_rnaseq_full_dataset/` and choose **Open Preview** or download it.)
...
Please take a few minutes to inspect the multiQC report. You can use the left panel for navigating the report. We will discuss details and your questions afterwards.   
